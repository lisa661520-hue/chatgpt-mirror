...
# 由于涉及到一些不可抗力因素，本项目即日起暂停，已部署的用户无影响，未部署的用户和需要更新的用户需要特殊访问许可才可部署，（大约10天后恢复更新）请联系：
 ## choose69145092@gmail.com

ChatGPT Mirror 是一个面向多用户场景的 ChatGPT 镜像管理项目，提供用户登录、账号管理、权限控制、访问记录和站点配置等功能。管理员可以集中维护可用账号和用户权限，普通用户通过统一入口访问已获授权的功能。**即日起暂停对公众维护，仅对特殊许可者维护**

项目重点关注多用户使用、共享账号隔离、移动端兼容、弱网体验和日常运维，**仅适合个人学习、内部研究及其他获得合法授权的非商业场景。**

---

## 目前致力于解决降智问题，其他功能可能会更新不及时 仅对部分人员开放
